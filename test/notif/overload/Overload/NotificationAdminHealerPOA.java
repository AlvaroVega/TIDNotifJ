//
// NotificationAdminHealerPOA.java (skeleton)
//
...
abstract public class NotificationAdminHealerPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements NotificationAdminHealerOperations {

  public NotificationAdminHealer _this() {
    return NotificationAdminHealerHelper.narrow(super._this_object());
  };

  public NotificationAdminHealer _this(org.omg.CORBA.ORB orb) {
    return NotificationAdminHealerHelper.narrow(super._this_object(orb));
  };
