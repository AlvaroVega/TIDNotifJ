//
// PushSupplierHelper.java (helper)
//
...
abstract public class PushSupplierHelper {
  ...
  public static String id() {
    return "IDL:org.omg/CosNotifyComm/PushSupplier:1.0";
  };

  public static void insert(org.omg.CORBA.Any any, PushSupplier value) {
    any.insert_Object((org.omg.CORBA.Object)value, type());
  };

  public static PushSupplier extract(org.omg.CORBA.Any any) {
    org.omg.CORBA.Object obj = any.extract_Object();
    PushSupplier value = narrow(obj);
    return value;
  };

  public static PushSupplier read(org.omg.CORBA.portable.InputStream is) {
    return narrow(is.read_Object(), true); 
  }

  public static void write(org.omg.CORBA.portable.OutputStream os, PushSupplier val) {
  ...
  private static PushSupplier narrow(org.omg.CORBA.Object obj, boolean is_a) {
    if (obj == null) {
      return null;
    }
    ...
    if (is_a || obj._is_a(id())) {
      _PushSupplierStub result = (_PushSupplierStub)new _PushSupplierStub();
      ((org.omg.CORBA.portable.ObjectImpl) result)._set_delegate
        (((org.omg.CORBA.portable.ObjectImpl) obj)._get_delegate());
      return (PushSupplier)result;
    }
    throw new org.omg.CORBA.BAD_PARAM();
  }
