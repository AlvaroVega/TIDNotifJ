//
// NotifyPublishPOA.java (skeleton)
//
...
abstract public class NotifyPublishPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements NotifyPublishOperations {

  public NotifyPublish _this() {
    return NotifyPublishHelper.narrow(super._this_object());
  };

  public NotifyPublish _this(org.omg.CORBA.ORB orb) {
    return NotifyPublishHelper.narrow(super._this_object(orb));
  };
