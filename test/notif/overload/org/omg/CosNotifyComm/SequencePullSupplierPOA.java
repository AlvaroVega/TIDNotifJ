//
// SequencePullSupplierPOA.java (skeleton)
//
...
abstract public class SequencePullSupplierPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements SequencePullSupplierOperations {

  public SequencePullSupplier _this() {
    return SequencePullSupplierHelper.narrow(super._this_object());
  };

  public SequencePullSupplier _this(org.omg.CORBA.ORB orb) {
    return SequencePullSupplierHelper.narrow(super._this_object(orb));
  };
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 0: {
      ...
      org.omg.CORBA.Any $max_number = _orb().create_any();
      $max_number.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_long));
      _params.add_value("max_number", $max_number, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      int max_number;
      max_number = $max_number.extract_long();
      org.omg.CosNotification.StructuredEvent[] _result = this.pull_structured_events(max_number);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CosNotification.EventBatchHelper.insert(_resultAny, _result);
    ...
    case 1: {
      ...
      org.omg.CosNotification.StructuredEvent[] _result = this.try_pull_structured_events(max_number, has_event);
      org.omg.CORBA.Any _resultAny = _orb().create_any();
      org.omg.CosNotification.EventBatchHelper.insert(_resultAny, _result);
      _request.set_result(_resultAny);
