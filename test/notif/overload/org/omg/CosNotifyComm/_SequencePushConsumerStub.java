//
// _SequencePushConsumerStub.java (stub)
//
...
public class _SequencePushConsumerStub
 ...
 implements SequencePushConsumer {
  ...
  public void push_structured_events(org.omg.CosNotification.StructuredEvent[] notifications)
    ...
    org.omg.CORBA.Request _request = this._request("push_structured_events");
    org.omg.CORBA.Any $notifications = _request.add_named_in_arg("notifications");
    org.omg.CosNotification.EventBatchHelper.insert($notifications,notifications);
  ...
  public void disconnect_sequence_push_consumer() {
    org.omg.CORBA.Request _request = this._request("disconnect_sequence_push_consumer");
    _request.invoke();
    java.lang.Exception _exception = _request.env().exception();
    if (_exception != null) {
      if (_exception instanceof org.omg.CORBA.UnknownUserException) {
