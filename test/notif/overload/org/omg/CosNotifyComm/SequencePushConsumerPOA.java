//
// SequencePushConsumerPOA.java (skeleton)
//
...
abstract public class SequencePushConsumerPOA
 extends org.omg.PortableServer.DynamicImplementation
 implements SequencePushConsumerOperations {

  public SequencePushConsumer _this() {
    return SequencePushConsumerHelper.narrow(super._this_object());
  };

  public SequencePushConsumer _this(org.omg.CORBA.ORB orb) {
    return SequencePushConsumerHelper.narrow(super._this_object(orb));
  };
  ...
  public void invoke(org.omg.CORBA.ServerRequest _request) {
    ...
    case 0: {
      ...
      org.omg.CORBA.Any $notifications = _orb().create_any();
      $notifications.type(org.omg.CosNotification.EventBatchHelper.type());
      _params.add_value("notifications", $notifications, org.omg.CORBA.ARG_IN.value);
      _request.arguments(_params);
      org.omg.CosNotification.StructuredEvent[] notifications;
      notifications = org.omg.CosNotification.EventBatchHelper.extract($notifications);
