//
// FilterableEventBodyHelper.java (helper)
//
...
abstract public class FilterableEventBodyHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "FilterableEventBody", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:org.omg/CosNotification/FilterableEventBody:1.0";
  };
