package es.tid.corba.TIDNotifTestClient.proxy_push_consumer;

import es.tid.corba.TIDNotifTestClient.common.ServiceClient;

import java.util.Properties;
import org.omg.NotificationChannelAdmin.ProxyPushConsumer;
import org.omg.NotificationChannelAdmin.ProxyPushConsumerHelper;
...
public class AdministrativeState extends ServiceClient
{
  ...
  public static void main(String args[])
  {
    ...
    ProxyPushConsumer push_consumer = ProxyPushConsumerHelper.narrow(ref);
    ...
    try 
    {
      ...
      if (new_state == -1)
      {
        state = push_consumer.administrative_state();
        if (state.value() == 0)
      ...
      else
      {
        ...
        push_consumer.administrative_state(state);
      }
    }
