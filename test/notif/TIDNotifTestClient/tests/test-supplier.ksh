...
/usr/j2se/bin/java $JAVA_RUN_OPTS es.tid.corba.TIDNotifTestClient.push_supplier_client.ThePushSupplierServer -TIDorb.max_blocked_time 25000 -f $DATA_DIR/test_info.$1.IN < admin.ior > $OUT_DIR/supplier.$1.out 2>&1
