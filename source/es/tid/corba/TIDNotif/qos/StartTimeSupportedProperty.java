...
public class StartTimeSupportedProperty extends QoSProperty
{
    boolean value;    
    
    protected StartTimeSupportedProperty(Property property, 
                              boolean value)
    {
        super(property);
        this.value = value;        
    ...
    protected static StartTimeSupportedProperty 
	...
	{        
        ...
        this.property = new Property(StartTimeSupported.value,
                                     prop_value);
	}
