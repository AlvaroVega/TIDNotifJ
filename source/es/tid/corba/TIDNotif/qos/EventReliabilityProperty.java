...
public class EventReliabilityProperty extends QoSProperty
{
    short value;
    
    
    protected EventReliabilityProperty(Property property, 
                                        short value)
    {
        super(property);
        this.value = value;        
    ...
    protected static EventReliabilityProperty 
    ...
    {  
        try {
            ...
            error.value = null;
             ...
             return new EventReliabilityProperty(property, value);                        
