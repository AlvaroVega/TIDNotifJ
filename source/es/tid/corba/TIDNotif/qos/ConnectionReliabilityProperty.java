...
public class ConnectionReliabilityProperty extends QoSProperty
{
    short value;
    
    
    protected ConnectionReliabilityProperty(Property property, 
                                        short value)
    {
        super(property);
        this.value = value;        
    ...
    protected static ConnectionReliabilityProperty 
    ...
    {        
        try {
            ...
            if(value != BestEffort.value && value != Persistent.value) {
                error.value = QoSAdmin.createPropertyError(property);
                error.value.available_range = 
            ...
            return new ConnectionReliabilityProperty(property, value);
            ...
            error.value = QoSAdmin.createPropertyError(property);
        	error.value.code = QoSError_code.BAD_VALUE;            	
        	error.value.available_range = admin.getConnectionReliabilityRange();        	 
            return null;
        }
