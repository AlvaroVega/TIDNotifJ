...
public class NotificationAdminImpl extends org.omg.NotificationService.NotificationAdminPOA implements NotificationAdminMsg
//public class NotificationAdminImpl extends es.tid.corba.TIDDistribAdmin.AgentPOA implements NotificationAdminMsg
{
  /**
   * The current orb.
   */
  ...
  NotificationAdminImpl( org.omg.CORBA.ORB orb, ServiceManager manager )
  {
    _orb = orb;
    _manager  = manager;
  }
...
/*
  public org.omg.DistributionChannelAdmin.DistributionChannelFactory
                                        dchannel_factory() throws CannotProceed
  {
    TIDNotifTrace.print(TIDNotifTrace.DEBUG, DCHANNEL_FACTORY);
    return _manager.channel_factory();
  }
*/
  ...
  public org.omg.NotificationChannelAdmin.NotificationChannel[] 
  ...
  // Returns a list with the channels.
  public String[] list_channels_id() throws CannotProceed
  {
    TIDNotifTrace.print(TIDNotifTrace.DEBUG, LIST_CHANNELS);
    return _manager.list_channels_id();
  }
} // End of public class NotificationAdminImpl
