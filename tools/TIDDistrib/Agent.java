...
{		
  ...
  //private static final int _OP_START    =  5;
  //private static final int _OP_STOP     =  6;
...
*/
    ...
    {
      System.err.println( "Operacion invalida (resolve|list|nlist|shutdown" );
      System.exit(1);
    }

    org.omg.CORBA.Object object_ref = null; 
    es.tid.corba.TIDDistribAdmin.Agent agent = null;
    try
    {
      object_ref = orb.string_to_object(utils.readIORString(ior_filename));
      agent = AgentHelper.narrow(object_ref);
    }
    catch (Exception e)
    {
      e.printStackTrace();
